            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="text-container">
                        <div class="image-container">
                            <a href="project.html">
                                <img class="img-fluid" src={{asset("assets/images/work-4.jpg")}} alt="alternative">
                            </a>
                        </div> <!-- end of image-container -->
                ...
                <div class="col-lg-4">
                    <div class="text-container">
                        <div class="image-container">
                            <a href="project.html">
                                <img class="img-fluid" src={{asset("assets/images/work-5.jpg")}} alt="alternative">
                            </a>
                        </div> <!-- end of image-container -->
                ...
                <div class="col-lg-4">
                    <div class="text-container">
                        <div class="image-container">
                            <a href="project.html">
                                <img class="img-fluid" src={{asset("assets/images/work-6.jpg")}} alt="alternative">
                            </a>
                        </div> <!-- end of image-container -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="details">
                                <img src={{asset("assets/images/testimonial-1.jpg")}} alt="alternative">
                                <div class="text">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="details">
                                <img src={{asset("assets/images/testimonial-2.jpg")}} alt="alternative">
                                <div class="text">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="details">
                                <img src={{asset("assets/images/testimonial-3.jpg")}} alt="alternative">
                                <div class="text">
